...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--count", type=int, default=80,
                         help="Number of particles (default: 80. Went 90 -> 200 -> too many per "
                              "real-world feedback -> 100 -> still too many, -20% -> 80, while keeping "
                              "the larger radius/opacity from the earlier tuning round - it was particle "
                              "size, not count, that mainly fixed visibility.")
